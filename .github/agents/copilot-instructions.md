...
- Python >=3.11, <3.14 + FastAPI >=0.115.0, uvicorn[standard] >=0.34.0, qdrant-client >=1.8.0, sentence-transformers >=2.3.0 (015-retrieval-accuracy)
- Qdrant (file-based, shared single client) with 4 collections: code, tests, docs, text (015-retrieval-accuracy)
...
## Recent Changes
- 015-retrieval-accuracy: Added Python >=3.11, <3.14 + FastAPI >=0.115.0, uvicorn[standard] >=0.34.0, qdrant-client >=1.8.0, sentence-transformers >=2.3.0
